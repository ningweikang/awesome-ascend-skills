---
name: external-gitcode-ascend-model-training
description: Model training on Ascend NPU. Invoke when user wants to launch training
  script and monitor training progress.
original-name: model-training
